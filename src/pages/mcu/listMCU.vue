    ...
    <div class="min-h-screen bg-linear-to-br from-slate-50 to-blue-50">
        ...
        <div class="2xxl:min-h-125 lg:min-h-112.5 md:min-h-100 sm:min-h-87.5 min-h-75 bg-cover bg-center bg-light relative z-1 w-full overflow-hidden pb-7.5 before:absolute before:left-0 before:top-0 before:size-full before:bg-[#07121E] before:opacity-70 after:w-full after:h-[calc(100%_-_80px)] after:absolute after:bottom-0 after:right-0 after:z-0 after:bg-[url(../../src/images/banner/bg.webp)] after:bg-no-repeat after:bg-position-[right_-13px_top] max-lg:after:hidden"
            ...
            <div class="container relative z-1 h-full table">
                <div
                    class="table-cell 2xxl:h-125 lg:h-112.5 md:h-100 sm:h-87.5 h-75 align-middle pt-22.5 pb-5 text-center">
                    <h1 class="2xxl:text-8xl xl:text-6xxl md:text-[48px] text-[32px] font-semibold mb-3.75 break-word text-white wow fadeInUp"
                        data-wow-delay="0.2s" data-wow-duration="0.8s">Medical Check Up</h1>
                    <nav class="wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
                        <ul class="inline-block rounded-5xl lg:py-2.5 py-1.5 lg:px-7.5 px-5 bg-white shadow-breadcrumb">
                            <li class="inline-block lg:text-base text-sm font-normal capitalize text-heading"><a
                                    href="index.html" class="text-primary">Home</a></li>
                            <li
            ...
            <div
                ...
                <ul class="flex gap-7.5 [writing-mode:tb-rl]">
                    <li><a class="text-sm uppercase text-white tracking-[1px]"
            ...
            <div
                class="absolute bottom-0 right-0 bg-primary size-71.25 rounded-full blur-[120px] opacity-50 max-xl:hidden">
            </div>
            <div
        ...
        <section class="py-16">
            <div class="container mx-auto px-4 max-w-6xl">
                <div class="text-center mb-12">
                    <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Layanan Pemeriksaan Kami</h2>
                    <p class="text-slate-600 text-lg max-w-2xl mx-auto">
                        Berbagai jenis pemeriksaan kesehatan dengan teknologi terkini dan tim medis profesional
                    </p>
                </div>

                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-16">
                    <template v-for="(s, index) in services" :key="s.id">
                        <div
                            class="bg-white p-4 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 group border border-slate-100">
                            <div
                                class="w-12 h-12 bg-blue-50 rounded-lg flex items-center justify-center mb-3 mx-auto group-hover:scale-110 transition-transform duration-300">
                                <svg v-if="s.icon === 'xray'" class="w-6 h-6 text-[#F46700]" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 7h18M3 17h18M7 7v10" />
                                </svg>
                                <svg v-else-if="s.icon === 'blood'" class="w-6 h-6 text-[#F46700]" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 2s4 4 4 7a4 4 0 11-8 0c0-3 4-7 4-7z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 13v8" />
                                </svg>
                                <svg v-else-if="s.icon === 'ecg'" class="w-6 h-6 text-[#F46700]" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M3 12h3l2-4 2 8 2-4 2 4 4-8h3" />
                                </svg>
                                <svg v-else-if="s.icon === 'ear'" class="w-6 h-6 text-[#F46700]" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 2c3 0 5 1 6 3s1 4 1 6-1 4-4 6c-2 1-3 1-5 1" />
                                </svg>
                                <svg v-else-if="s.icon === 'urine'" class="w-6 h-6 text-[#F46700]" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 2s4 4 4 7a4 4 0 11-8 0c0-3 4-7 4-7z" />
                                </svg>
                                <svg v-else class="w-6 h-6 text-[#F46700]" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 7h18M3 17h18" />
                                </svg>
                            </div>
                            <h3 class="text-sm font-semibold text-slate-800 text-center mb-2">{{ s.title }}</h3>
                            <p class="text-xs text-slate-600 text-center leading-tight">{{ s.desc }}</p>
                        </div>
                    </template>
                </div>
                ...
                <div class="mb-16">
                    <div class="text-center mb-8">
                        <h2 class="text-3xl font-bold text-slate-800 mb-4">Paket Medical Check Up</h2>
                        <p class="text-slate-600">Pilih paket yang sesuai dengan kebutuhan kesehatan Anda</p>
                    </div>

                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <template v-for="(p, index) in packages" :key="p.id">
                            <div
                                ...
                                <div class="p-6 pt-0 mt-auto">
                                    <div class="flex gap-3">
                                        <a :href="`/appointment`"
                                            class="flex-1 bg-linear-to-r from-[#FF7D14] to-[#ff562c] text-white text-center py-2.5 px-4 rounded-lg hover:scale-[1.05] transition-all duration-300 text-sm font-medium shadow-sm hover:shadow-md">
                                            Daftar Sekarang
                                        </a>
                                        <a :href="waLink"
                                            class="flex items-center justify-center w-12 h-12 border border-slate-300 rounded-lg hover:bg-slate-50 transition-colors hover:border-[#FF7D14]">
                                            <svg class="w-5 h-5 text-slate-600 hover:text-[#FF7D14] transition-colors"
                ...
                <!-- Layanan Onsite -->
                <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden mb-16">
                    <div class="grid lg:grid-cols-2 gap-8">
                        <div class="p-8">
                            ...
                            <p class="text-slate-600 mb-6 leading-relaxed">
                                Kami menyediakan layanan MCU onsite dengan tim medis profesional yang datang ke lokasi
                                Anda.
                                Cocok untuk perusahaan, institusi, atau individu yang membutuhkan kenyamanan ekstra.
                            </p>

                            <div class="space-y-4 mb-8">
                                <div class="flex items-start gap-3">
                                    <div
                                        class="w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0">
                            ...
                            <a :href="waLink"
                                class="inline-flex items-center gap-2 bg-linear-to-r from-[#FF7D14] to-[#ff562c] text-white px-6 py-3 rounded-lg hover:scale-[1.05] transition-all duration-300 font-medium shadow-sm hover:shadow-md">
                            ...
                            <div class="grid gap-4">
                                <div class="flex items-start gap-4 p-4 bg-white rounded-lg">
                                    <div
                                        ...
                                        <svg class="w-5 h-5 text-[#F46700]" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600">Tim terlatih untuk pengambilan sampel yang
                                            aman dan nyaman</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4 p-4 bg-white rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600">Format digital dengan analisis mendalam untuk
                                            kebutuhan HR</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4 p-4 bg-white rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-slate-600">Dokter dan tenaga medis bersertifikat dengan
                                            pengalaman</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="text-center">
                    <div class="bg-white rounded-2xl p-8 shadow-sm border border-slate-100">
                        ...
                        <p class="text-slate-600 mb-6 max-w-2xl mx-auto">
                            Konsultasikan kebutuhan MCU perusahaan Anda dengan tim kami. Dapatkan penawaran terbaik
                            untuk karyawan Anda.
                        </p>
                        <a :href="waLink"
                            class="inline-flex items-center gap-3 bg-linear-to-r from-[#FF7D14] to-[#ff562c] text-white px-8 py-4 rounded-lg hover:scale-[1.05] transition-all duration-300 font-semibold text-lg shadow-sm hover:shadow-md">
...
const packages = ref([
    {
        id: 'lemak',
        title: 'Paket Profil Lemak',
        tests: ['Cholesterol Total', 'Trigliserida', 'Cholesterol HDL', 'Cholesterol LDL'],
        note: 'Pemeriksaan profil lemak lengkap untuk deteksi risiko kardiovaskular.',
    },
    {
        id: 'diabetes',
        title: 'Paket Diabetes',
        tests: ['Glukosa Darah Puasa', 'Glukosa 2 Jam PP', 'Urine Lengkap'],
        note: 'Screening komprehensif untuk deteksi dini diabetes.',
    },
    {
        id: 'fungsi',
        title: 'Paket Fungsi Ginjal',
        tests: ['Ureum', 'Creatinin', 'Asam Urat', 'Urine Lengkap', 'eGFR'],
        note: 'Evaluasi menyeluruh fungsi ginjal dan kesehatan saluran kemih.',
    },
    {
        id: 'obesitas',
        title: 'Paket Metabolik',
        tests: ['Cholesterol Total', 'Trigliserida', 'HDL/LDL', 'Glukosa Puasa', 'HbA1c', 'BMI'],
        note: 'Paket lengkap untuk screening risiko metabolik dan obesitas.',
    },
    {
        id: 'fungsi-hati',
        title: 'Paket Fungsi Hati',
        tests: ['SGOT', 'SGPT', 'Gamma-GT', 'HBsAg', 'Urine Lengkap'],
        note: 'Pemeriksaan enzim hati dan screening hepatitis.',
    },
    {
        id: 'jantung',
        title: 'Paket Kardiologi',
        tests: ['Cholesterol Total', 'Trigliserida', 'LDL/HDL', 'Glukosa Puasa', 'HbA1c', 'Rekam Jantung', 'Troponin T'],
        note: 'Screening jantung lengkap dengan marker spesifik.',
    },
]);
...
const waLink = 'https://wa.me/081290094900?text=Halo%20Caya,%20saya%20mau%20tanya%20paket%20MCU%20%2F%20onsite';
</script>
