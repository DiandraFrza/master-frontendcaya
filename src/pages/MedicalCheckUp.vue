  ...
  <section class="py-20 bg-gradient-to-br from-gray-50 to-white">
    <div class="container mx-auto px-4 max-w-7xl">
      <div class="text-center max-w-4xl mx-auto mb-12">
        <span class="inline-block text-sm font-medium text-[#f15840] uppercase tracking-wider mb-4 bg-amber-100 px-3 py-1 rounded-full"> Layanan Unggulan MCU K3 </span>
        <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-tight">Pemeriksaan MCU Profesional untuk Perusahaan & Individu</h2>
      ...
      <div class="mb-12">
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <article v-for="branch in branches" :key="branch.id" class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all">
            <div class="flex justify-between items-start">
              ...
              <div class="ml-4 flex flex-col items-end">
                <span v-if="branch.hasPromo" class="text-xs bg-amber-100 text-amber-700 px-3 py-1 rounded-full mb-2">Promo</span>
      ...
      <div class="mb-12">
        ...
        <div class="grid md:grid-cols-3 gap-6">
          <div v-for="item in walkIn" :key="item.branch" class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg flex flex-col h-full">
            <div class="flex-1">
            ...
            <div class="mt-4 pt-4 border-t border-gray-100">
              <a :href="'/branches/' + item.branch.toLowerCase().replace(/ /g, '')" class="text-sm font-semibold text-[#F94327]">Detail Cabang →</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="mb-12">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <article v-for="service in services" :key="service.id" class="group bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-xl transition-all flex flex-col h-full">
            <div class="flex items-start gap-4 flex-1">
              <div class="flex-none w-14 h-14 rounded-xl bg-gradient-to-br from-[#FF7D14] to-[#F94327] text-white flex items-center justify-center">
        ...
        <div class="space-y-3">
          ...
          <ul class="text-sm text-gray-600 space-y-2">
            <li class="flex items-center">
              <svg class="w-4 h-4 text-[#F94327] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
