  ...
  <section class="py-16 bg-gradient-to-b from-white to-slate-50">
    <div class="container mx-auto px-4 max-w-5xl">
      ...
      <div class="text-center mb-12">
        ...
        <h2 class="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Perjalanan Kami</h2>
        <p class="text-slate-600 max-w-2xl mx-auto text-lg">Perjalanan dedikasi kami dalam memberikan layanan kesehatan laboratorium yang berkualitas dan terpercaya</p>
      </div>
            ...
            <div class="md:w-1/2 md:pl-12 order-3">
              <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300">
                <div class="flex items-center mb-3">
                  ...
                  <h3 class="text-xl font-bold text-slate-800">Awal Perjalanan</h3>
                </div>
                <p class="text-slate-600 leading-relaxed">Bermula dari klinik kecil dengan fokus pada pemeriksaan kesehatan menyeluruh, meletakkan fondasi pelayanan kesehatan yang berkualitas.</p>
              </div>
            </div>
          </div>
            ...
            <div class="md:w-1/2 md:pl-12 order-3">
              <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 hover:shadow-md transition-all duration-300">
                <div class="flex items-center mb-3">
                  ...
                  <h3 class="text-xl font-bold text-slate-800">Standar & Integritas</h3>
                </div>
                <p class="text-slate-600 leading-relaxed">Memformalkan protokol sesuai standar medis tertinggi sambil tetap mempertahankan nilai-nilai etika dan pelayanan yang manusiawi.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="text-center mt-12">
        <div class="bg-white inline-flex items-center px-6 py-3 rounded-full shadow-sm border border-slate-200">
          ...
          <span class="text-slate-700 font-medium">Terus Berkembang, Terus Melayani</span>
        </div>
      </div>
    </div>
  </section>
