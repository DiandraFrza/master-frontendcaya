            ...
            <div class="container relative z-1 h-full table">
              <div
                ...
                <h1
                  ...
                  data-wow-delay="0.2s" data-wow-duration="0.8s">About Us</h1>
                ...
                <div class="lg:w-1/2 w-full mb-7.5">
                  <div class="sm:mb-7.5 mb-5">
                    ...
                    <p class="xl:text-lg text-base font-light md:mb-12 mb-6 wow fadeInUp" data-wow-delay="0.4s"
                      ...
                      Pengembangan usaha terus kami upayakan melalui penerapan sistem manajemen mutu serta teknologi
                      pelayanan berkualitas terbaik.

                      Terima kasih dan penghargaan setinggi-tingginya kami sampaikan kepada masyarakat, para dokter,
                      mitra kerja, dan semua pihak atas dukungan, kepercayaan, dan kerja samanya selama ini.

                      Kami berharap, Caya Laboratorium Klinik dapat menjadi mitra utama dalam pelayanan jasa kesehatan
