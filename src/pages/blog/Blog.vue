        ...
        <div class="container relative z-1 h-full table">
            <div class="table-cell 2xxl:h-125 lg:h-112.5 md:h-100 sm:h-87.5 h-75 align-middle pt-22.5 pb-5 text-center">
                <h1 class="2xxl:text-8xl xl:text-6xxl md:text-[48px] text-[32px] font-semibold mb-3.75 break-word text-white wow fadeInUp"
                    data-wow-delay="0.2s" data-wow-duration="0.8s">Blog</h1>
            ...
            <div class="row">
                <div class="xl:w-2/3 lg:w-full mb-7.5">
                                ...
                                <div class="relative">
                                    <div class="mb-2.5">
                                        <ul class="flex flex-wrap items-center gap-1.25">
                                            <li
                                                class="bg-amber-100 text-primary rounded-xxl font-medium text-2xs py-1.25 pr-3.75 pl-5.75 leading-[1.4] relative inline-flex mr-1.25 items-center gap-1 flex-wrap after:absolute after:size-1.5 after:rounded-full after:bg-primary after:left-2.5">
                                                17 May 2025</li>
                                            <li
                                                class="bg-amber-100 text-primary rounded-xxl font-medium text-2xs py-1.25 pr-3.75 pl-5.75 leading-[1.4] relative inline-flex mr-1.25 items-center gap-1 flex-wrap after:absolute after:size-1.5 after:rounded-full after:bg-primary after:left-2.5">
                                                By <a href="javascript:void(0);">Nashid Martines</a></li>
                                        </ul>
                                    </div>
                                    <h3 class="xl:text-2xl text-xl mb-2.5"><a href="blog-details.html">Radiant
                                            reflections expert dermatology and skin.</a></h3>
                                    <p class="text-2sm">It is a long established fact that a reader will be distracted
                                        by the readable content.</p>
                                    <a href="blog-details.html" class="text-2sm font-medium capitalize text-primary">
                        ...
                        <div class="md:w-1/2 mb-7.5 wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="0.8s">
                            <div class="relative z-1 lg:p-7.5 p-5 h-full duration-200 bg-white rounded-3xl group">
                                ...
                                <div class="relative">
                                    ...
                                    <h3 class="xl:text-2xl text-xl mb-2.5"><a href="blog-details.html">Glow guide your
                                            path to perfect skin health</a></h3>
                                    <p class="text-2sm">It is a long established fact that a reader will be distracted
                                        by the readable content.</p>
                                    <a href="blog-details.html" class="text-2sm font-medium capitalize text-primary">
                                        Read more <i class="feather icon-arrow-right"></i>
                        ...
                        <div class="md:w-1/2 mb-7.5 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="0.8s">
                            <div class="relative z-1 lg:p-7.5 p-5 h-full duration-200 bg-white rounded-3xl group">
                                ...
                                <div class="relative">
                                    ...
                                    <h3 class="xl:text-2xl text-xl mb-2.5"><a href="blog-details.html">Brilliant skin
                                            blog your dermatology care resource</a></h3>
                                    <p class="text-2sm">It is a long established fact that a reader will be distracted
                                        by the readable content.</p>
                                    <a href="blog-details.html" class="text-2sm font-medium capitalize text-primary">
                                        Read more <i class="feather icon-arrow-right"></i>
                    ...
                    <div class="text-center mt-7.5 m-lg-t0 wow fadeInUp" data-wow-delay="1.4s" data-wow-duration="0.8s">
                        <a href="javascript:void(0);" class="rounded-full btn-lg btn-icon btn-primary dz-load-more"
                            rel="ajax/blog-grid.html">
                            Load More <i class="feather icon-refresh-ccw ms-2"></i>
                        </a>
                    </div>
                </div>
                <div class="xl:w-1/3 lg:w-full">
                    <aside class="my-sticky mb-7.5 space-top-0 right">
                            ...
                            <div class="search-bx">
                                <form role="search" method="post">
                                    <div class="relative flex flex-wrap items-stretch w-full">
                                        <input name="text"
                                            class="w-full h-15 py-2.5 pl-5 pr-12.5 text-2sm sm:rounded-2lg rounded-md bg-primary-30 border-2 border-primary g-prim placeholder:text-bodycolor"
                                            placeholder="Search" type="text">
                                        <div class="-ms-px">
                                            <button type="submit"
                                                class="absolute right-1.25 top-1/2 -translate-y-1/2 text-3xl z-99 size-12 bg-transparent">
                        ...
                        <div
                            class="p-7.5 sm:rounded-xxl rounded-lg bg-white sm:mb-11.25 mb-5 widget_categories style-1">
                            <div class="mb-6.25">
                                <h4 class="text-xl">Category</h4>
                            </div>
                            <ul>
                                <li
                                    class="relative py-2.5 pl-6.25 text-2xs text-primary text-right font-medium before:content-['\e829'] before:text-primary before:absolute before:left-0 before:font-['feather'] before:font-light before:text-lg before:top-2.25">
                                ...
                                <li
                                    class="relative py-2.5 pl-6.25 text-2xs text-primary text-right font-medium before:content-['\e829'] before:text-primary before:absolute before:left-0 before:font-['feather'] before:font-light before:text-lg before:top-2.25">
                                    <a class="float-left text-2sm text-bodycolor" href="blog-grid.html">Blood</a> (17)
                                </li>
                                <li
                                    class="relative py-2.5 pl-6.25 text-2xs text-primary text-right font-medium before:content-['\e829'] before:text-primary before:absolute before:left-0 before:font-['feather'] before:font-light before:text-lg before:top-2.25">
                                    <a class="float-left text-2sm text-bodycolor" href="blog-grid.html">Food</a> (13)
                                </li>
                                <li
                                    class="relative py-2.5 pl-6.25 text-2xs text-primary text-right font-medium before:content-['\e829'] before:text-primary before:absolute before:left-0 before:font-['feather'] before:font-light before:text-lg before:top-2.25">
                                    <a class="float-left text-2sm text-bodycolor" href="blog-grid.html">Health</a> (06)
                                </li>
                                <li
                                    class="relative py-2.5 pl-6.25 text-2xs text-primary text-right font-medium before:content-['\e829'] before:text-primary before:absolute before:left-0 before:font-['feather'] before:font-light before:text-lg before:top-2.25">
                                    <a class="float-left text-2sm text-bodycolor" href="blog-grid.html">Mental
                                        Health</a> (17)
                                </li>
                                <li
                                    class="relative py-2.5 pl-6.25 text-2xs text-primary text-right font-medium before:content-['\e829'] before:text-primary before:absolute before:left-0 before:font-['feather'] before:font-light before:text-lg before:top-2.25">
                                    <a class="float-left text-2sm text-bodycolor" href="blog-grid.html">Therapy</a> (13)
                                </li>
                                <li
                                    class="relative py-2.5 pl-6.25 text-2xs text-primary text-right font-medium before:content-['\e829'] before:text-primary before:absolute before:left-0 before:font-['feather'] before:font-light before:text-lg before:top-2.25">
                                    <a class="float-left text-2sm text-bodycolor" href="blog-grid.html">Walking</a> (06)
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="widget-post-bx">
                                <div class="flex items-center mb-6.25">
                                    ...
                                    <div class="relative ml-4">
                                        <div class="mb-1">
                                            <ul>
                                                <li class="text-2xs text-primary font-medium uppercase"><a
                                                        href="blog-grid.html">03 August 2025</a></li>
                                            </ul>
                                        </div>
                                        <h6 class="font-medium text-base"><a href="blog-details.html">The Art of
                                                Managing Business and Patient Care</a></h6>
                                    </div>
                                </div>
                                <div class="flex items-center mb-6.25">
                                    <div class="w-22.5 min-w-22.5 h-25 rounded-2xl relative overflow-hidden">
                        ...
                        <div class="p-7.5 sm:rounded-xxl rounded-lg bg-white sm:mb-11.25 mb-5">
                            ...
                            <div class="tagcloud">
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Acupressure</a>
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Allgemein</a>
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Blood</a>
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Food</a>
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Health</a>
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Mental Health</a>
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Therapy</a>
                                <a class="relative py-2.5 px-3.75 inline-block text-sm text-secondary leading-[1.4] sm:rounded-2lg rounded-md bg-light mr-2 mb-2.5 hover:bg-primary hover:text-white"
                                    href="blog-grid.html">Walking</a>
                            </div>
                        </div>
                    </aside>
                </div>
