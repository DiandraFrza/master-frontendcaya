...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Konten artikel dan berita untuk blog';
    displayName: 'Artikel';
    pluralName: 'articles';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gambar: Schema.Attribute.Media<'images'>;
    ...
    penulis: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Tim Caya Medical'>;
    publishedAt: Schema.Attribute.DateTime;
    ringkasan: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'judul'>;
    tags: Schema.Attribute.Relation<'manyToMany', 'api::tag.tag'>;
    unggulan: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiKategoriKategori extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artikels: Schema.Attribute.Relation<'oneToMany', 'api::article.article'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    artikels: Schema.Attribute.Relation<'manyToMany', 'api::article.article'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
